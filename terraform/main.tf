...
module "azure_container_apps" {
  ...
  mongodb_connection_str                = "mongodb://${var.cosmos_account_name}:${module.cosmosdb_for_mongodb.mongodb_primary_key}@${var.cosmos_account_name}.mongo.cosmos.azure.com:10255/?ssl=true&replicaSet=globaldb&retrywrites=false&maxIdleTimeMS=120000&appName=@${var.cosmos_account_name}@"
